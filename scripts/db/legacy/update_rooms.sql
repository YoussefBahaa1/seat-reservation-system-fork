...
update rooms set floor_id=(
    select floor_id from floors where name = '1. Obergeschoss' and building_id = (
        select building_id from buildings where name = 'Hauptstelle Dresden,  Bautzner Str.19ab' limit 1
    ) limit 1) 
where remark in ('Raum 145','Raum 117','Raum 119','Raum 121','Raum 128','Raum 134','Raum 133') and building = 'Bautzner Str. 19a/b';
