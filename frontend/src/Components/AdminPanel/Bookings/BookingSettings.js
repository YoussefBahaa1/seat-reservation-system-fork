...
const leadTimeOptionsHours = Array.from({ length: 25 }, (_, i) => i * 0.5);
...
export default function BookingSettings() {
  ...
  const [maxDurationChoice, setMaxDurationChoice] = useState('6');
  const [maxAdvanceChoice, setMaxAdvanceChoice] = useState('30');
